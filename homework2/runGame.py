...
def simulateMultipleGames(agents_dict, simulation_times, ccgame):
    ...
    for i in range(simulation_times):
        ...
        print('game', i + 1, 'finished', 'winner is player ', run_result[0])
...
def callback(ccgame):
    ...
    teamAgent = StereoNyMinimaxAgent(ccgame)
    simulateMultipleGames({1: teamAgent, 2: simpleGreedyAgent}, 3, ccgame)
