...
if __name__ == '__main__':
    ...
    for solver_name, solver_fn in mdp_solvers.items():
        ...
        policy_grids, utility_grids = solver_fn(iterations=25, discount=0.9)
    ...
    plt.show()
    print(ql.regret)
    print(policy_grids[:, :, -1]-ql_policy_grids[:, :, -1])
    print(np.count_nonzero(policy_grids[:, :, -1]-ql_policy_grids[:, :, -1]))
